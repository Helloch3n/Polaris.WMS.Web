...
<template>
  <div>
    ...
    <n-modal :show="createVisible" preset="card" title="新增用户" style="width: 560px" @update:show="(value) => { createVisible = value }">
    ...
    <n-modal :show="editVisible" preset="card" title="编辑用户" style="width: 560px" @update:show="(value) => { editVisible = value }">
    <n-form label-width="90">
      <n-form-item label="用户名" required>
    ...
    <n-modal :show="resetPasswordVisible" preset="card" :title="`重置密码 - ${selectedUser?.userName ?? ''}`" style="width: 480px" @update:show="(value) => { resetPasswordVisible = value }">
    <n-form label-width="90">
    ...
    <n-modal :show="assignRoleVisible" preset="card" style="width: 760px" @update:show="(value) => { assignRoleVisible = value }">
