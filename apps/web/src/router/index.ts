        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              path: 'container',
              name: 'ContainerList',
              component: () => import('../views/masterData/container/ContainerIndex.vue'),
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              component: () => import('../views/inbound/MiscInboundOrders/MiscInboundOrdersIndex.vue'),
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              component: () => import('../views/masterData/accountAlias/AccountAliasIndex.vue'),
              meta: { title: '账户别名', requiresAuth: true, order: 6 },
            },
            {
              path: 'cost-center',
              name: 'CostCenterList',
              component: () => import('../views/masterData/costCenter/CostCenterIndex.vue'),
